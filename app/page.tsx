...
export default function Home() {
  ...
  // Parallax: video drifts slightly slower than the page (translation only —
  // cheap compositor op, no repaint). The clip overflows ±10% so no gap shows.
  ...
  return (
    <>
      ...
      >
        ...
        >
          <motion.video
            src={cldVideo(HERO_CLIP.src, { quality: 'auto:best' })}
            poster={HERO_CLIP.poster ?? cldPoster(HERO_CLIP.src, { quality: 'auto:best' })}
            autoPlay
            muted
            loop
            playsInline
            preload="auto"
            style={reduce ? undefined : { y: clipY }}
          ...
          >
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="mt-4 font-serif font-medium leading-[1.1] text-parchment text-[clamp(1.5rem,3.5vw,2.75rem)]">
                <motion.span
