      ...
      <div className="mt-5">
        ...
        >
          <div className="flex flex-row items-center gap-2">
            ...
            <motion.p variants={VARIANTS_ITEM} className="-mt-1 text-xs text-zinc-500 dark:text-zinc-400">{BLOG_POSTS.length} posts</motion.p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-5 w-full">
                    <div className="flex-shrink-0 w-10 mt-1 text-right">
                    ...
                    <div className="flex-1 space-y-0 pb-2">
                      <div className="font-normal text-black dark:text-white">{highlightText(post.title, query)}</div>
